...
class PEFTSeq2SeqTrainer(Seq2SeqTrainer):
    ...
    def prediction_step(
        ...
        if hasattr(self.model, "encoder") and self.model.encoder.main_input_name != self.model.main_input_name:
            ...
            generation_inputs = inputs[self.model.main_input_name] # self.model.main_input_name: input_ids
        ...
        generated_tokens = self.model.generate(**generation_inputs) # pad_token_id=self.tokenizer.pad_token_id, max_new_tokens=None
